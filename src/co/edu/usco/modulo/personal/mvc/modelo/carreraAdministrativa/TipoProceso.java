...
public class TipoProceso implements Serializable {
	...
	private String nombre;//varchar](100) NULL,
	 ...
	 * @param estado
	 */
	public TipoProceso(int codigo, String nombre, int estado) {
		this.codigo = codigo;
		this.nombre = nombre;
		this.estado = estado;
	}
	...
	public String toString() {
		return "TipoProceso [codigo=" + codigo + ", nombre=" + nombre + ", estado=" + estado + "]";
	}
