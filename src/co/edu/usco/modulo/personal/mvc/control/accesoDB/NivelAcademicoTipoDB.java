 ...
 *
 */
public class NivelAcademicoTipoDB implements ConexionDB {
	private Logger imp ;
	static String COLUMNAS = "nat.nat_codigo ,nat.nat_nombre, nat.nat_estado  ";
	private String SQL_SELECT = "SELECT " + COLUMNAS + " FROM   nivel_academico_tipo nat with(nolock) ";
	/* (non-Javadoc)
