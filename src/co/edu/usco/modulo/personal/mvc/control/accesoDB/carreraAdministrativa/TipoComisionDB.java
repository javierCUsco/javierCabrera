...
import co.edu.usco.modulo.personal.mvc.modelo.carreraAdministrativa.TipoComision;

/**
 * @author INGENIERO JAVIER CABRERA
 *
 */
public class TipoComisionDB implements ConexionDB {
	private Logger imp ;
	/* (non-Javadoc)
	...
	public Object getAll(Object obj) {
		...
		imp =Logger.getLogger(getClass().getName());
		 LinkedList<TipoComision> lista = new LinkedList<TipoComision>();
...
//			 usuarioOb admin= (usuarioOb) param[1];
			...
			sql.append("SELECT tic_codigo,tic_nombre,tic_estado  ");
			sql.append("FROM cadtiva.tipo_comision as tc  with(nolock)  ");
//			sql.append("where cert_estado=1  ");
			...
			while(resul.next()){
				lista.add(new TipoComision(resul.getInt(1),resul.getString(2),resul.getInt(3)));
