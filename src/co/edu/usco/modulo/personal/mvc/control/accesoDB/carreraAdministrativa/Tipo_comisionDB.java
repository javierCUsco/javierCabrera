 ...
 *
 */
public class Tipo_comisionDB implements conexion {
	private Logger imp ;
	/* (non-Javadoc)
	...
	public Object getAll(Object obj) {
		...
		imp =Logger.getLogger(getClass().getName());
		 LinkedList<Tipo_comisionOb> lista = new LinkedList<Tipo_comisionOb>();
...
//			sql.append("where cert_estado=1  ");
			...
			while(resul.next()){
				lista.add(new Tipo_comisionOb(resul.getInt(1),resul.getString(2),resul.getInt(3)));
