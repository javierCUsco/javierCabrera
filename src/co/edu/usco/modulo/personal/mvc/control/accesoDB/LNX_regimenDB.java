...
public class LNX_regimenDB implements ConexionDB {
	...
	public Object getAll(Object obj) {
		...
		imp =Logger.getLogger(getClass().getName());
		 LinkedList<LNX_regimenOb> lista = new LinkedList<LNX_regimenOb>();
...
//			 usuarioOb admin= (usuarioOb) param[1];
			...
			sql.append("SELECT [reg_codigo],[reg_nombre],[reg_acronimo]  ");
			sql.append("FROM [LNX_regimen]  with(nolock)  ");
