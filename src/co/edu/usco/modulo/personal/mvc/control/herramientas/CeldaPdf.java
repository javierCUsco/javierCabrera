...
//			System.out.println("Rectangle.NO_BORDER "+Rectangle.NO_BORDER);
	 ...
	 * @return
	 */
	public static PdfPCell getCeldaFuente(String info,Font fuente,  float paddin,int border,int alineacion, int estilo,float altura,  int colspan, int rowspan, int color){

		
		PdfPCell celda = new PdfPCell(new Paragraph(info, fuente)); // color
