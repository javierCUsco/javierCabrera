...
import co.edu.usco.modulo.personal.mvc.modelo.carreraAdministrativa.TipoActualizacion;

/**
 * @author INGENIERO JAVIER CABRERA
 *
 */
public class TipoActualizacionDB implements ConexionDB {
	private Logger imp ;
	/* (non-Javadoc)
	...
	public Object getAll(Object obj) {
		...
		imp =Logger.getLogger(getClass().getName());
		 LinkedList<TipoActualizacion> lista = new LinkedList<TipoActualizacion>();
...
//			sql.append("where cert_estado=1  ");
			...
			while(resul.next()){
				lista.add(new TipoActualizacion(resul.getInt(1),resul.getString(2),resul.getInt(3)));
