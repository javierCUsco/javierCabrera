...
import co.edu.usco.modulo.personal.mvc.modelo.carreraAdministrativa.TipoNotificacion;

/**
 * @author INGENIERO JAVIER CABRERA
 *
 */
public class TipoNotificacionDB implements ConexionDB {
	private Logger imp ;
	/* (non-Javadoc)
	...
	public Object getAll(Object obj) {
		...
		imp =Logger.getLogger(getClass().getName());
		 LinkedList<TipoNotificacion> lista = new LinkedList<TipoNotificacion>();
...
//				sql.append("where cert_estado=1  ");
				...
				while(resul.next()){
					lista.add(new TipoNotificacion(resul.getInt(1),resul.getString(2),resul.getInt(3)));
